package com.github.wxiaoqi.security.api.util;
...
public class GeoHashKit {
    ...
    private final static Map<Object, Integer> _decodemap = new HashMap();
    static {
    ...
    public static void main(String[] args) {
        ...
        String gc1 = ghf.encode(39.9923584, 116.608678);
        String gc2 = ghf.encode(40.071677, 116.409525);
        String gc3 = ghf.encode(39.84038, 116.28804);
 
        System.out.println(gc1);
        System.out.println(gc2);
        System.out.println(gc3.substring(0, 4));
