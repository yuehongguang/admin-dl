...
public class CommonConstants {
    ...
    public static final Integer EX_USER_LOGIN_CODE = 40103;
    // 客户端token异常
    ...
    public static final String CONTEXT_KEY_CHILD_ID = "currentChildId";
    ...
    //短信验证
    public static final String RANDOMKEY = "identifyCode:random:%s";
}
